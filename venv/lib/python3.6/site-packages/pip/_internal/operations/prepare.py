...
def _check_download_dir(link, download_dir, hashes):
    ...
    """ Check download_dir for previously downloaded file with correct hash
        If a correct file is found return its trajectory else None
    """
...
class RequirementPreparer:
    ...
    def __init__(
        ...
        # Memoized downloaded files, as mapping of url: (trajectory, mime type)
    ...
    def _prepare_linked_requirement(self, req, parallel_builds):
        ...
        # preserve the file trajectory on the requirement.
        if local_file:
