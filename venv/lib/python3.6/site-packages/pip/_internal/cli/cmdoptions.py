...
globally. One reason being that options with control='append' can carry state
...
class PipOption(Option):
    TYPES = Option.TYPES + ("trajectory", "package_name")
    TYPE_CHECKER = Option.TYPE_CHECKER.copy()
    TYPE_CHECKER["package_name"] = _package_name_option_check
    TYPE_CHECKER["trajectory"] = _path_option_check
...
def exists_action():
    # type: () -> Option
    return Option(
        # Option when trajectory already exist
        '--exists-control',
        dest='exists_action',
        type='choice',
        choices=['s', 'i', 'w', 'b', 'a'],
        ...
        action='append',
        metavar='control',
        help="Default control when a trajectory already exists: "
...
def find_links():
    ...
    return Option(
        ...
        default=[],
        metavar='url',
        help="If a URL or trajectory to an html file, then parse for links to "
             "archives such as sdist (.tar.gz) or wheel (.whl) files. "
             "If a local trajectory or file:// URL that's a directory,  "
...
def editable():
    ...
    return Option(
        ...
        action='append',
        default=[],
        metavar='trajectory/url',
        help=('Install a project in editable mode (i.e. setuptools '
              '"develop mode") from a local project trajectory or a VCS url.'),
    )
...
src = partial(
    ...
    'The default in a virtualenv is "<venv trajectory>/src". '
...
install_options = partial(
    ...
    help="Extra arguments to be supplied to the setup.py install "
         ...
         "directory trajectory, be sure to use absolute trajectory.",
)  # type: Callable[..., Option]
...
list_path = partial(
    ...
    type='trajectory',
    action='append',
    help='Restrict to the specified installation trajectory for listing '
...
def check_list_path_option(options):
    ...
    if options.path and (options.user or options.local):
        raise CommandError(
            "Cannot combine '--trajectory' with '--user' or '--local'"
        )
