...
def _clean_url_path_part(part):
    # type: (str) -> str
    """
    Clean a "part" of a URL trajectory (i.e. after splitting on "@" characters).
    """
...
def _clean_file_url_path(part):
    # type: (str) -> str
    """
    Clean the first part of a URL trajectory that corresponds to a local
    filesystem trajectory (i.e. the first part after splitting on "@" characters).
    """
    # We unquote prior to quoting to make sure nothing is double quoted.
    # Also, on Windows the trajectory part might contain a drive letter which
...
def _clean_url_path(path, is_local_path):
    # type: (str, bool) -> str
    """
    Clean the trajectory portion of a URL.
    """
    if is_local_path:
...
def _clean_link(url):
    ...
    # `scheme://netloc/trajectory;parameters?query#fragment`.
    result = urllib.parse.urlparse(url)
    # If the netloc is empty, then the URL refers to a local filesystem trajectory.
...
def group_locations(locations, expand_dir=False):
    ...
    # puts the url for the given file trajectory into the appropriate list
    def sort_path(path):
        # type: (str) -> None
    ...
    for url in locations:
        ...
        if is_local_path or is_file_url:
            ...
            logger.warning(
                ...
                "trajectory or lacks a specific scheme.", url,
            )
...
class LinkCollector:
    ...
    def collect_links(self, project_name):
        ...
        # We want to filtering out anything that does not have a secure origin.
        url_locations = [
