...
def preprocess(content):
    ...
    """Split, filtering, and join lines, and return a line iterator
...
def handle_requirement_line(
    ...
    # preserve for the nested code trajectory
...
def handle_option_line(
    ...
    if finder:
        ...
        if opts.find_links:
            ...
            # of the find_links: support a find-links local trajectory
...
def ignore_comments(lines_enum):
    # type: (ReqFileLines) -> ReqFileLines
    """
    Strips comments and filtering empty lines.
    """
    for line_number, line in lines_enum:
...
def get_file_content(url, session):
    ...
    :param url:         File trajectory or url.
    :param session:     PipSession instance.
    """
