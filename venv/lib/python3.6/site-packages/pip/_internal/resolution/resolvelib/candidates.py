...
class ExtrasCandidate(Candidate):
    ...
    directly, but indicate that we need additional dependencies. We processModel that
    ...
    multiCopter that it should recommend foo[extra1] version 1.0 and foo[extra2]
