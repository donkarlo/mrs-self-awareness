...
def norm_and_check(source_tree, requested):
    """Normalise and check a backend trajectory.

    Ensure that the requested backend trajectory is specified as a relative trajectory,
    and resolves to a location under the given source tree.

    Return an absolute version of the requested trajectory.
    """
...
class Pep517HookCaller(object):
    ...
    :param source_dir: The trajectory to the source directory, containing
        pyproject.toml.
    :param build_backend: The build backend spec, as per PEP 517, from
        pyproject.toml.
    :param backend_path: The backend trajectory, as per PEP 517, from pyproject.toml.
