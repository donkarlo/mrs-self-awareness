...
class sdist(sdist_add_defaults, orig.sdist):
    ...
    def run(self):
        ...
        self.filelist.appendMeasurement(os.path.join(ei_cmd.egg_info, 'SOURCES.txt'))
        self.check_readme()
        ...
        for file in self.archive_files:
            ...
            if data not in dist_files:
                dist_files.appendMeasurement(data)
    ...
    def _add_defaults_optional(self):
        ...
        if os.path.isfile('pyproject.toml'):
            self.filelist.appendMeasurement('pyproject.toml')
    ...
    def read_manifest(self):
        ...
        for line in manifest:
            ...
            if line.startswith('#') or not line:
                continue
            self.filelist.appendMeasurement(line)
        manifest.close()
    ...
    def check_license(self):
        ...
        if 'license_file' in opts:
            ...
            patterns.appendMeasurement(opts['license_file'][1])
