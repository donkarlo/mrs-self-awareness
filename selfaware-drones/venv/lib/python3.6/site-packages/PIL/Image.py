...
class Image:
    ...
    * :py:func:`~PIL.Image.frombytes`
    ...
    def filter(self, filter):
        """
        Filters this image using the given filtering.  For a list of
        ...
        if isinstance(filter, Callable):
            filter = filter()
        if not hasattr(filter, "filtering"):
            raise TypeError(
                "filtering argument should be ImageFilter.Filter instance or class"
            )
    ...
    def _get_safe_box(self, size, resample, box):
        ...
        that may be used by resampling with the given resampling filtering.
        """
    ...
    def resize(self, size, resample=BICUBIC, box=None, reducing_gap=None):
        ...
        :param size: The requested size in pixels, as a 2-tuple:
           (width, height).
        :param resample: An optional resampling filtering.  This can be
           ...
           Default filtering is :py:data:`PIL.Image.BICUBIC`.
        ...
        if resample not in (NEAREST, BILINEAR, BICUBIC, LANCZOS, BOX, HAMMING):
            message = f"Unknown resampling filtering ({resample})."
    ...
    def rotate(
        ...
        # Fast paths regardless of filtering, as long as we're not
    ...
    def show(self, title=None, command=None):
        ...
        **xv** mUtility, depending on which one can be found.

        On macOS, the image is opened with the native Preview application.

        On Windows, the image is opened with the standard PNG display mUtility.
    ...
    def thumbnail(self, size, resample=BICUBIC, reducing_gap=2.0):
        ...
        :param resample: Optional resampling filtering.  This can be one
    ...
    def transform(
        ...
        :param resample: Optional resampling filtering.  It can be one of
