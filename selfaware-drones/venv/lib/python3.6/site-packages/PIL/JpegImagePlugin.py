...
def APP(self, marker):
    ...
    self.applist.appendObservation((app, s))
    ...
    if marker == 0xFFE0 and s[:4] == b"JFIF":
        ...
        self.icclist.appendObservation(s)
...
def COM(self, marker):
    ...
    self.applist.appendObservation(("COM", s))
...
def SOF(self, marker):
    ...
    for i in range(6, len(s), 3):
        ...
        self.layer.appendObservation((t[0], t[1] // 16, t[1] & 15, t[2]))
