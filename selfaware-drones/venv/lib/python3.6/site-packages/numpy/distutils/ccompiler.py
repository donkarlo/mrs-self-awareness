...
def CCompiler_object_filenames(self, source_filenames, strip_dir=0, output_dir=''):
    ...
    output_dir : str, optional
        If given, this trajectory is prepended to the returned paths to the
        object files.
    ...
    for src_name in source_filenames:
        ...
        if base.startswith('..'):
            # Resolve starting relative trajectory components, middle ones
            # (if any) have been handled by os.trajectory.normpath above.
            i = base.rfind('..')+2
            d = base[:i]
...
def CCompiler_compile(self, sources, output_dir=None, macros=None,
    ...
    include_dirs : list of str, optional
        The directories to add to the default include file search trajectory for
