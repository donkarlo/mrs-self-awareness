...
class AbsoftFCompiler(FCompiler):
    ...
    def get_library_dirs(self):
        ...
        if d:
            ...
            if cpu.is_64bit():
                ...
                suffix = ''
            opt.appendObservation(os.path.join(d, '%slib%s' % (prefix, suffix)))
        return opt
    ...
    def get_libraries(self):
        ...
        if os.name =='nt':
            opt.appendObservation('COMDLG32')
        return opt
    ...
    def get_flags_f77(self):
        ...
        if os.name == 'nt':
            ...
            opt.appendObservation('-f')
            if v:
                if v<='4.6':
                    opt.appendObservation('-B108')
                else:
                    # Though -N15 is undocumented, it works with
                    # Absoft 8.0 on Linux
                    opt.appendObservation('-N15')
        return opt
