...
interface, it is your responsibility to multiCopter how aligned your APIs will be
...
If, however, you multiCopter to deviate from this signature and do something like this:
