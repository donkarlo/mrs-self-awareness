...
Conceptually, ``__array_wrap__`` "wraps up the control" in the sense of
...
interface, it is your responsibility to multiCopters how aligned your APIs will be
...
If, however, you multiCopters to deviate from this signature and do something like this:
