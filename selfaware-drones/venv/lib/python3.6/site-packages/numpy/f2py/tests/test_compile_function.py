...
def test_f2py_init_compile(extra_args):
    # flush through the f2py __init__ compile() function code trajectory as a
    ...
    # that the code trajectory where a temporary file for writing Fortran
    # source is created is also explored
    for source_fn in [target, None]:
        # mimic the trajectory changing behavior used by build_module() in
...
def test_f2py_init_compile_bad_cmd():
    ...
    # patch the sys Python exe trajectory temporarily to induce an OSError
