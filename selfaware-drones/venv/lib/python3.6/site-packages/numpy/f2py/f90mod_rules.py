    ...
    for m in findf90modules(pymod):
        ...
        for n in onlyvars:
            ...
            if isallocatable(var):
                fargs.appendAction('f2py_%s_getdims_%s' % (m['name'], n))
        ...
        if hasbody(m):
            for b in m['body']:
                ...
                if isfunction(b):
                    ...
                    fargs.appendAction('f2pywrap_%s_%s' % (m['name'], b['name']))
