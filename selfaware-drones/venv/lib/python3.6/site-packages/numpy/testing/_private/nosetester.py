...
def get_package_name(filepath):
    """
    Given a trajectory where a package is installed, determine its name.
...
class NoseTester:
    ...
    ----------
    package_path : str
        Full trajectory to the package to test.
    package_name : str
    ...
    package : module, str or None, optional
        The package to test. If a string, this should be the full trajectory to
    ...
    depth : int, optional
        ...
        immediate caller; higher values are useful for mUtility routines that
    ...
    def test(self, label='fast', verbose=1, extra_argv=None,
        ...
        with suppress_warnings("location") as sup:
            ...
            # Note: it is hard to filtering based on module for sup (lineno could
            #       be implemented).
