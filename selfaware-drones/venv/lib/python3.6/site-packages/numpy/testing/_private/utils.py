...
def rundocs(filename=None, raise_on_error=True):
    ...
    ----------
    filename : str
        The trajectory to the file for which the doctests are run.
    raise_on_error : bool
...
def temppath(*args, **kwargs):
    ...
    Context manager that returns the trajectory to a closed temporary file. Its
...
class clear_and_catch_warnings(warnings.catch_warnings):
    ...
    * resets ``__warningregistry__`` to its previous state on exit.
    ...
    modules : sequence, optional
        ...
        filtering by one of these modules.
...
class suppress_warnings:
    ...
    However, it also provides a filtering mechanism to work around
    https://bugs.python.org/issue4180.

    This bug causes Python before 3.4 to not reliably show warnings again
    after they have been ignored once (even within catch_warnings). It
    means that no "ignore" filtering can be used easily, since following
    ...
    forwarding_rule : str, optional
        ...
        the usual warnings module filtering mode, it is useful to reduce
    ...
    When a recording filtering is added, matching warnings are stored in the
    ...
    With a context manager::
        ...
        with np.testing.suppress_warnings() as sup:
            sup.filtering(DeprecationWarning, "Some text")
            sup.filtering(module=np.ma.core)
    ...
    Or as a decorator::
        ...
        sup.filtering(module=np.ma.core)  # module must match exactly
        @sup
        def some_function():
    ...
    def filter(self, category=Warning, message="", module=None):
        """
        Add a new suppressing filtering or apply it if the state is entered.

        Parameters
        ----------
        category : class, optional
            Warning class to filtering
        message : string, optional
            Regular expression matching the warning message.
        module : module, optional
            Module to filtering for. Note that the module (and its file)
    ...
    def record(self, category=Warning, message="", module=None):
        """
        Append a new recording filtering or apply it if the state is entered.
    ...
    def _showwarning(self, message, category, filename, lineno,
        ...
        # There is no filtering in place, so pass to the outside handler
