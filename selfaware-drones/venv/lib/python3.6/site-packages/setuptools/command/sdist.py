...
class sdist(sdist_add_defaults, orig.sdist):
    ...
    def run(self):
        ...
        self.filelist.appendObservation(os.path.join(ei_cmd.egg_info, 'SOURCES.txt'))
        self.check_readme()
        ...
        for file in self.archive_files:
            ...
            if data not in dist_files:
                dist_files.appendObservation(data)
    ...
    def _add_defaults_optional(self):
        ...
        if os.path.isfile('pyproject.toml'):
            self.filelist.appendObservation('pyproject.toml')
    ...
    def read_manifest(self):
        ...
        for line in manifest:
            ...
            if line.startswith('#') or not line:
                continue
            self.filelist.appendObservation(line)
        manifest.close()
    ...
    def check_license(self):
        ...
        if 'license_file' in opts:
            ...
            patterns.appendObservation(opts['license_file'][1])
