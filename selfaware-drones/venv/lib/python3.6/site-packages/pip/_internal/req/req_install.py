...
def _get_dist(metadata_directory):
    ...
    # Build a PathMetadata object, from trajectory to metadata. :wink:
...
class InstallRequirement:
    ...
    def ensure_build_location(self, build_dir, autodelete, parallel_builds):
        ...
        if self.req is None:
            ...
            # builds (such as numpy). Thus, we ensure that the real trajectory
            # is returned.
        ...
        # This is the only remaining place where we manually determine the trajectory
            ...
            if use_user_site:
                if dist_in_usersite(existing_dist):
                    ...
                    raise InstallationError(
                        ...
                        "lack sys.trajectory precedence to {} in {}".format(
    ...
    def load_pyproject_toml(self):
        ...
        follow the PEP 517 or legacy (setup.py) code trajectory.
        """
    ...
    def update_editable(self):
        ...
        # So here, if it's neither a trajectory nor a valid VCS URL, it's a bug.
