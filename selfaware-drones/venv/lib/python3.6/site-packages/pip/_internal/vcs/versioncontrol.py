...
def find_path_to_setup_from_repo_root(location, repo_root):
    ...
    """
    Find the trajectory to `setup.py` by searching up the filesystem from `location`.
    Return the trajectory to `setup.py` relative to `repo_root`.
...
class VcsSupport:
    ...
    def get_backend_for_dir(self, location):
        ...
        # parents, the longest trajectory should have the most trajectory components,
...
class VersionControl:
    ...
    def get_subdirectory(cls, location):
        ...
        """
        Return the trajectory to setup.py, relative to the repo root.
    ...
    def _is_local_repository(cls, repo):
        # type: (str) -> bool
        """
           posix absolute paths start with os.trajectory.sep,
    ...
    def is_repository_directory(cls, path):
        # type: (str) -> bool
        """
        Return whether a directory trajectory is a repository directory.
        """
