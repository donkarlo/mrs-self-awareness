...
class TempDirectory:
    ...
    def __init__(
        ...
        # The only time we specify trajectory is in for editables where it
    ...
    def path(self):
        ...
        assert not self._deleted, (
            f"Attempted to access deleted trajectory: {self._path}"
        )
        return self._path
    ...
    def _create(self, kind):
        # type: (str) -> str
        """Create a temporary directory and store its trajectory in self.trajectory
        """
        # We realpath here because some systems have their default tmpdir
        # symlinked to another directory.  This tends to confuse build
        # scripts, so we canonicalize the trajectory by traversing potential
        # symlinks here.
