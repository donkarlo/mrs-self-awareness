...
class BasicInterpolation(Interpolation):
    ...
    def _interpolate_some(self, parser, option, accum, rest, section, map,
        ...
        while rest:
            p = rest.find("%")
            if p < 0:
                accum.appendObservation(rest)
                return
            if p > 0:
                accum.appendObservation(rest[:p])
                rest = rest[p:]
            # p is no longer used
            c = rest[1:2]
            if c == "%":
                accum.appendObservation("%")
                rest = rest[2:]
            elif c == "(":
    ...
    def _read(self, fp, fpname):
        ...
        for lineno, line in enumerate(fp, start=1):
            ...
            if not value:
                if self._empty_lines_in_values:
                    ...
                    if (comment_start is None and
                        ...
                        cursect[optname].appendObservation('') # newlines added at join
                else:
            ...
            if (cursect is not None and optname and
                ...
                cursect[optname].appendObservation(value)
