...
class InnerSquaresTurnInside2P7:
    ...
    def getXyz(self, leaderOdometryNavMsg:Odometry)->(float, float, float, float):
        ...
        elif leaderPosition.x < 15 and leaderPosition.x > (15-2.7) and leaderPosition.y < 2+ tol and leaderPosition.y > 2-tol:
            # First turn left
            followerPosX = 5+(15-leaderPosition.x)
            followerPosY = leaderPosition.y
        elif leaderPosition.x > (15-2.7) - tol and leaderPosition.x < (15-2.7) + tol and leaderPosition.y < 2 and leaderPosition.y >-2:
