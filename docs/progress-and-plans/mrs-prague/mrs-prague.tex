...
\institute{Pervaisive Computing Group (Alpen-adria university)}
...
\begin{document}
	...
	\begin{frame}{Topics}
		\begin{itemize}
			\item Self-awareness as a dynamic Bayesian networks approach
			\item Force field analysis of repulsive and attractive forces
			\item Variational auto encoders
			\item Continual/lifelong learning learning 
		\end{itemize}
	\end{frame}
